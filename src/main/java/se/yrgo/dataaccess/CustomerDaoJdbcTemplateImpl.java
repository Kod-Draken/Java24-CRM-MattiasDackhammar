...
public class CustomerDaoJdbcTemplateImpl implements CustomerDao {
    ...
    private static final String INSERT_CUSTOMER_CALL = "INSERT INTO CALL (TIMEANDDATE, NOTES, CUSTOMER_ID) VALUES (?,?,?) WHERE CUSTOMER_ID=?";

    private static final String GET_CALL_BY_CUSTOMER = "SELECT * FROM CALL WHERE CUSTOMER_ID=?";
